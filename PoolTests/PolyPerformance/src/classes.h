...
namespace {
  namespace {
    ...
    edm::Wrapper<detVectorPerformance::DoubleVector<detVectorPerformance::Array<int,10> > > wdvai10;
    edm::Wrapper<detVectorPerformance::IndexedVector<detVectorPerformance::Array<int,10> > > wivai10;
  }
